            ...
            <Grid item xs={8}>
              ...
              >
                ...
                <Grid item xs={7}>
                  ...
                  <FormLabel className={classes.lineBreak} component="legend">
                    Voice(Clear voice without much of stuttering)
                  </FormLabel>
                  <FormControl component="fieldset">
                    <RadioGroup row>
                      <FormControlLabel
                ...
                <Grid item xs={7}>
                  <FormLabel className={classes.lineBreak} component="legend">
                    Eye (Keeps good eye contact while talking)
                  </FormLabel>
                  <FormControl component="fieldset">
                    <RadioGroup row>
                      <FormControlLabel
                ...
                <Grid item xs={7}>
                  <FormLabel className={classes.lineBreak} component="legend">
                    Nervousness(Very evident during interaction)
                  </FormLabel>
                  <FormControl component="fieldset">
                    <RadioGroup row>
                      <FormControlLabel
                ...
                <Grid item xs={7}>
                  <FormLabel className={classes.lineBreak} component="legend">
                    Confidence(In general displays confidence)
                  </FormLabel>
                  <FormControl component="fieldset">
                    <RadioGroup row>
                      <FormControlLabel
                ...
                <Grid item xs={7}>
                  <FormLabel className={classes.lineBreak} component="legend">
                    Emotional stability(Feeling calm and able to manage
                    emotions)
                  </FormLabel>
                  <FormControl component="fieldset">
                    <RadioGroup row>
                ...
                <Grid item xs={7}>
                  <FormLabel className={classes.lineBreak} component="legend">
                    Inferiority complex(Feels inferior to others in general)
                  </FormLabel>
                  <FormControl component="fieldset">
                    <RadioGroup row>
                      <FormControlLabel
                ...
                <Grid item xs={7}>
                  <Typography className={classes.lineBreak} variant="h6">
                    HISTÓRICO PESSOAL OU FAMILIAR DE EVENTO ADVSERSO RELACIONADO
                    A ANESTESIA
                  </Typography>
                  <Divider />
                </Grid>
